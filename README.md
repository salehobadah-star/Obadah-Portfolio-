...
**CV:** [bit.ly/obadahpro](https://bit.ly/obadahpro)  
...
|---|---|
| Email address | `href="mailto:..."` and visible text in Contact section |
| Phone number | `href="tel:..."` and visible text |
...
📄 [bit.ly/obadahpro](https://bit.ly/obadahpro)
